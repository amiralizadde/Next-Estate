...
const Navbar = () => {
  ...
  return (
    <navbar className=" bg-white lg:bg-black fixed right-0 left-0 z-40 ">
      <div className="max-lg:container w-full flex items-center justify-between  h-[70px]  lg:h-[60px] lg:px-9">
        ...
        <div className="flex w-auto">
          <p className="text-xl font-bold text-black lg:text-white">
          ...
          <ul className="hidden lg:flex  items-center justify-start text-white child:pe-5 child:ms-4  child:font-Dana child:text-base ms-5" >
            <li className="active text-yellow-100">خانه</li>
            <li>آگهی های ملک</li>
            <li>درباره ما</li>
            <li>تماس با ما</li>
          </ul>
        ...
        <div className="flex ">
          <button className="hidden   relative lg:flex items-center justify-center mx-2 rounded border text-center border-yellow-100 py-2 child:text-white pe-6 ps-8">
           <p className="hover:text-yellow-100"><span className=" text-2xl right-3 absolute">+</span><span className="text-xs font-Dana font-bold ">افزودن ملک</span></p>
          </button>
      ...
      {isShowMenu ? (
        <div className="lg:hidden">
          <div className={`container transition-all overflow-hidden ${styles.showMenu}`} >
