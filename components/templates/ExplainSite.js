    ...
    <div className="bg-[#f9f7f6] py-24">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 sm:px-16 md:px-32  pt-12">
        <div className="relative  flex flex-col items-center justify-center">
          <Image src="/performance/performance1.png" width={1000} height={500} className="w-60 h-40 my-5" quality={100}/>
        ...
        <div className="relative  flex flex-col items-center justify-center">
          <Image src="/performance/performance2.png" width={1000} height={500} className="w-60 h-40 my-5" quality={100} />
        ...
        <div className="relative  flex flex-col items-center justify-center">
          <Image src="/performance/performance3.png" width={1000} height={500} className="w-60 h-40 my-5" quality={100}/>
